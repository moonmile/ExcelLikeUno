...
現在の LibreOffice の Python は 3.12 なので、以下のパスに配置されます。

```powershell
C:\Users\<ユーザー名>\AppData\Roaming\Python\Python312\site-packages\
```
...
sheet.range("A2:C2").backcolor = 0xFFBF00  # A2:C2 の背景色を設定
...
- 0.3.0 (2026-03-07) : 内部的に Sheet/Range/Cell を Spreadsheet/SheetRangeCell/SheetCell に変更, CellProperties 関係を整理
